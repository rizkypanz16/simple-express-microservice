...
exports.postProducts = (req, res) => {
  var query =
    "INSERT INTO products (product_name, product_description, product_quantity, product_price, product_image, product_category) VALUES ('" +
